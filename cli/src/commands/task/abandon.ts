...
export default class TaskAbandon extends Command {
  static description = 'Mark a task as abandoned'
  ...
  async run(): Promise<void> {
    const { args } = await this.parse(TaskAbandon)
